...
function Features1() {
  return (
    <div><div class=" p-4 bg-white dark:bg-gray-800 container mx-auto  relative py-26 lg:mt-20">
    <div class="relative">
            ...
            <div class="mt-10 lg:-mx-4 relative relative-20 lg:mt-0 lg:col-start-1">
                <div class="relative space-y-4">
                    <div class="flex items-end justify-center lg:justify-start space-x-4">
                        <img class="rounded-lg shadow-lg w-32 md:w-56" width="200" src="https://source.unsplash.com/featured/300x201" alt="1"/>
                        <img class="rounded-lg shadow-lg w-40 md:w-64" width="260" src="https://source.unsplash.com/featured/300x201" alt="2"/>
                    </div>
                    <div class="flex items-start justify-center lg:justify-start space-x-4 ml-12">
                        <img class="rounded-lg shadow-lg w-24 md:w-40" width="170" src="https://source.unsplash.com/featured/300x201" alt="3"/>
                        <img class="rounded-lg shadow-lg w-32 md:w-56" width="200" src="https://source.unsplash.com/featured/300x201" alt="4"/>
                    </div>
                </div>
            </div>
        </div>
